...
fun RestaurantDetailsScreen() {
    ...
    val discountFoodList = listOf(
        DiscountMenu("Aloo Tikki Burger", "200","180", "10%",3, "10", "Most selling burger of ours.", R.drawable.allu_tikkiburger),
        DiscountMenu("Aloo Tikki Burger", "200","180", "10%",3, "10", "Most selling burger of ours.", R.drawable.allu_tikkiburger),
        DiscountMenu("Aloo Tikki Burger", "200","180", "10%",3, "10", "Most selling burger of ours.", R.drawable.allu_tikkiburger),
        DiscountMenu("Aloo Tikki Burger", "200","180", "10%",3, "10", "Most selling burger of ours.", R.drawable.allu_tikkiburger),
        DiscountMenu("Aloo Tikki Burger", "200","180", "10%",3, "10", "Most selling burger of ours.", R.drawable.allu_tikkiburger),
    ...
    Column(modifier = Modifier.fillMaxSize()
        ...
        TopAppBar(
            ...
            title = {
//                Text("Burger King", style = MaterialTheme.typography.h6)
            },
            navigationIcon = {
        ...
        LazyColumn(
            ...
            // Section Title
            item {
                SectionTitle(title = "Best in Burger")

                Spacer(modifier = Modifier.height(8.dp))
            }

            items(discountFoodList){ food->
                DiscountFoodCard(
                    discountMenu = food
                )
