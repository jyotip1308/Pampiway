    ...
    Scaffold(
        ...
        )
        {
            ...
            RedButton("Continue", buttonHeight = 40.dp) {
                ...
                MyComponents.mainViewModel.createCustomer(full_name = fullName, email = email, phone_number = phoneNumber, dob = dob)

                Log.d("SignUp", "SignUpScreen: Successfull")
            ...
            Row(
                ...
                Text(
                    ...
                    modifier = Modifier.clickable {
                        MyComponents.navController.navigate(SIGNINSCREEN)
                    }
                )
            }
        }
